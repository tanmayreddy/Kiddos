	    ...
	    <div class="container11 d-flex align-items-center">
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	        	...
	        	<li class="nav-item active"><a href="branch.php" class="nav-link">Branch</a></li>
      ...
      <div class="container11">
        <div class="row no-gutters slider-text align-items-center justify-content-center">
          <div class="col-md-9 ftco-animate text-center">
            <h1 class="mb-2 bread">Our Branches</h1>
            <p class="breadcrumbs"><span class="mr-2"><a href="Kiddos.php">Home <i class="ion-ios-arrow-forward"></i></a></span> <span>Branches <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
